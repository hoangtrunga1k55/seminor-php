                            ...
                            <div id="target-content" class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    foreach ($result as $row){
                                        echo "<tr id='row".$row[0]."'> <td>" . $row[0] . "</td> <td>" . $row[1] . "</td> <td>" . $row[2] . "</td> <td><button  type=\"button\" class=\"btn btn-default add\" data-toggle=\"modal\" data-target=\"#modal-default\">Thêm</button>|
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="ten" placeholder="nhập tên hội thảo" required>
                        </div>
                        <div class="modal-body">
                            <input type="text" name="mota" placeholder="nhập mô tả" required>
                        </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.delete', function(){
            ...
            if (checkstr ==true) {
                ...
                $clicked_btn = $(this);
                $.ajax({
                    url: '/project-metting/Controller/Admin/HoiThaoController/delete.php',
                    type: 'GET',
                    data: {
                        'delete': 1,
                        'id': id,
        ...
        $(document).on('click', '.btn-primary.add', function(){
            ...
            $clicked_btn = $(this);
            $.ajax({
                url: '/project-metting/Controller/Admin/HoiThaoController/add.php',
                type: 'POST',
                data: {
                    'ten': ten,
                    'mota': mota,
                ...
                success: function(response){
                    ...
                    $('tbody').append("<tr id=\"row"+response+"\"'> <td>"+response+"</td> <td>"+ten+"</td> <td>"+mota+"</td> <td><button type=\"button\" class=\"btn btn-default add\" data-toggle=\"modal\" data-target=\"#modal-default\">Add</button>|        <button type=\"button\" class=\"btn btn-default edit\" data-toggle=\"modal\" data-target=\"#modal-default\" data-id=\"6\">Edit</button>|<button class=\"delete btn btn-default\" data-id=\"6\">Delete</button></td> </tr>");
                }
            });
        });
        ...
        $(document).on('click', '.btn-primary.edit', function(){
            ...
            $clicked_btn = $(this);
            $.ajax({
                url: '/project-metting/Controller/Admin/HoiThaoController/editUser.php',
                type: 'POST',
                data: {
                    'id':id,
                    'ten': ten,
                ...
                success: function(response){
                    ...
                    $('body').removeClass('modal-open');
                    $("#row"+id+"").remove();
                    $('tbody').append("<tr id=\"row"+id+"\"'> <td>"+id+"</td> <td>"+ten+"</td> <td>"+mota+"</td><td><button type=\"button\" class=\"btn btn-default add\" data-toggle=\"modal\" data-target=\"#modal-default\">Add</button>|        <button type=\"button\" class=\"btn btn-default edit\" data-toggle=\"modal\" data-target=\"#modal-default\" data-id=\"6\">Edit</button>|<button class=\"delete btn btn-default\" data-id=\"6\">Delete</button></td> </tr>");
        ...
        $(document).on('click', '.editUser', function(){
            ...
            $clicked_btn = $(this);
            $.ajax({
                url: '/project-metting/Controller/Admin/HoiThaoController/edit.php',
                type: 'GET',
                data: {
                    'id': id,
                },
                success: function(response){
                    ...
                    $("#modal-default1 input[name=mota]").val(response[2]);
                    $('.modal.fade.show').removeClass('show');
                    $('body').removeClass('modal-open');
                }
            });
