                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="thoigian" placeholder="nhập tài khoản" required>
                        </div>
                        <div class="modal-body">
                            <input type="text" name="noidung" placeholder="nhập hình ảnh" required>
                        </div>
                        <div class="modal-body">
                            <input type="text" name="id_lichhoithao" placeholder="nhập bình luận" required>
                        </div>
            ...
            <div class="modal fade" id="modal-default1" style="display: none" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="thoigian" placeholder="nhập tên" required>
                        </div>
                        <div class="modal-body">
                            <input type="text" name="noidung" placeholder="nhập nội dung" required>
                        </div>
                        <div class="modal-body">
                            <input type="text" name="id_lichhoithao" placeholder="nhập bình luận" required>
                        </div>
