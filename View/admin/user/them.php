                ...
                <div class="row">
                    <div class="col-md-6"> <!-- general form elements -->
                        <div class="card card-primary">
                            ...
                            <form role="form" method="post" action="/project-metting/Controller/Admin/UserController/add.php">
                                <div class="card-body">
                                    <div class="form-group"><label for="exampleInputEmail1">Tài Khoản</label> <input
                                                type="text" name="taikhoan" class="form-control" id=""
                                                placeholder="Nhập tài khoản"></div>
                                    <div class="form-group"><label for="exampleInputPassword1">Mật khẩu</label> <input
                                                name="matkhau" type="password" class="form-control" id=""
                                                placeholder="Nhập mật khẩu"></div>
                                    <div class="form-check">
                                        <label for="">Nhập Vai Trò</label>
                                        <input name="vaitro" value="1" type="checkbox" class="form-check-input" id="">
                                    </div>
                                    <div class="form-group"><label for="exampleInputPassword1">Số Điện Thoại</label> <input
                                                type="text" class="form-control" id="" name="sdt"
