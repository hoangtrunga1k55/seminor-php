...
$id = $data['id'];
$user = new user();
echo $result = $user->getEditUser($id);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="content-wrapper"> <!-- Content Header (Page header) -->
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1 class="m-0 text-dark">Dashboard</h1></div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Dashboard v1</li>
                        </ol>
                    </div><!-- /.col --> </div><!-- /.row --> </div><!-- /.container-fluid --> </div>
        <!-- /.content-header -->
                ...
                <div class="row">
                    <div class="col-md-6"> <!-- general form elements -->
                        <div class="card card-primary">
                            ...
                            <form role="form" method="post" action="/project-metting/Controller/Admin/UserController/edit.php?id=<?php echo $result[0][0] ?>">
                                <div class="card-body">
                                    <div class="form-group"><label for="exampleInputEmail1">Tài Khoản</label> <input name="taikhoan" value="<?php echo $result[0][1]?>"
                                                type="text" class="form-control" id=""
                                                placeholder="Nhập tài khoản"></div>
                                    <div class="form-group"><label for="exampleInputPassword1">Mật khẩu</label> <input
                                                name="matkhau" value="<?php echo $result[0][2]?>"type="password" class="form-control" id=""
                                                placeholder="Nhập mật khẩu"></div>
                                    <div class="form-check">
                                        <label for="">Nhập Vai Trò</label>
                                        <input type="checkbox" name="vaitro" value="<?php echo $result[0][3]?>" class="form-check-input" id="">
                                    </div>
                                    <div class="form-group"><label for="exampleInputPassword1">Số Điện Thoại</label> <input
                                                name="sdt" value="<?php echo $result[0][4]?>" type="text" class="form-control" id=""
